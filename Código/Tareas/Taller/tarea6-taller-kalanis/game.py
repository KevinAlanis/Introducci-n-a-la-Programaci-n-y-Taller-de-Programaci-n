...
for i in range(50):
    ...
    bloque = Bloque(NEGRO, 20, 15,"banana.png")
...
protagonista = Protagonista(ROJO, 20, 15,"minion.png")
...
while not hecho:
    ...
    for bloque in lista_impactos_bloques:
        ...
        imagenPuntos = letra18.render('Puntos '+str(puntuacion), True, (200,200,200), (0,0,0) )                   
